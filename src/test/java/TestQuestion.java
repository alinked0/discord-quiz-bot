...
public class TestQuestion {
    ...
    @Test
    @DisplayName("Test getTrueOptions method")
    void testGetTrueOptions() {
        ...
        List<Option> trueOptions = q.getTrueOptions();
    ...
    @Test
    @DisplayName("Test getFalseOptions method")
    void testGetFalseOptions() {
        ...
        List<Option> falseOptions = q.getFalseOptions();
    ...
    @Test
    @DisplayName("Test getOptionsRearraged and rearrageOptions methods")
    void testRearrangeOptions() {
        ...
        // Test getOptionsRearraged()
        List<Option> rearranged10 = q.getOptionsRearraged();
        ...
        List<Option> rearranged11 = q.getOptionsRearraged();
        ...
        assertNotEquals(originalOrder, rearranged2, "rearrageOptions should change the order.");
        // Verify content is still the same
        assertTrue(rearranged2.containsAll(originalOrder) && originalOrder.containsAll(rearranged2));
